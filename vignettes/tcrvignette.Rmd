...
#                    twb[[2]]$CDR3.nucleotide.sequence)
repOverlap(twb[1:2], 'exact', 'nuc')

repOverlap(twb, 'exact', 'nuc', .norm = T)
# Intersect by amino acid clonotypes + V genes
repOverlap(twb, 'exact', 'aa', .vgene = T)

# Plot a heatmap of the number of shared clonotypes.
vis.heatmap(repOverlap(twb, 'exact', 'aa', .vgene = T), .title = 'twb - (ave)-intersection', .labs = '')
```
...
# Next two calls are equal. Here is why you need to use the repOverlap fun.
