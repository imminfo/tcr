...
HUMAN_TRDD = c('TRDD1', 'TRDD2')

HUMAN_TRDJ = c('TRDJ1', 'TRDJ2')

HUMAN_TRDV = c('TRAV6-7/DV9', 'TRAV13-4/DV7', 'TRAV21/DV12', 'TRDV2-1', 'TRAV15-1/DV6-1', 'TRAV15D-2/DV6D-2', 
               'TRDV1', 'TRDV4', 'TRAV14D-3/DV8', 'TRDV2-2', 'TRAV15D-1/DV6D-1', 
               'TRAV16D/DV11', 'TRAV15-2/DV6-2', 'TRDV5', 'TRAV4-4/DV10')

HUMAN_TRGJ = c('TRGJ4', 'TRGJ2', 'TRGJ1', 'TRGJ3')

HUMAN_TRGV = c('TRGV5', 'TRGV1', 'TRGV4', 'TRGV3', 'TRGV7', 'TRGV2', 
               'TRGV6')
